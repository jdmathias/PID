...
gamma=0.3;npas=19;
errorchoice=2;%1: economic error; 2: CO2 error
...
figure
plot(2015:5:(2010+(npas-1)*5),Perror(2:end)/max(Perror),'k',2010:5:(2010+(npas-1)*5),Ierror/max(Ierror),'r',2020:5:(2010+(npas-1)*5),Derror(3:end)/max(Derror),'g');
